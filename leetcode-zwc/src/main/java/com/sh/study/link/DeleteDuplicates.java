...
//        ListNode result = deleteDuplicates2(NodeUtil.createListNodeByArr(new int[]{1, 1, 2, 3, 3,3}));
        ListNode result = deleteDuplicates2(NodeUtil.createListNodeByArr(new int[]{1, 1, 1, 2, 3}));
//        ListNode result = deleteDuplicates2(NodeUtil.createListNodeByArr(new int[]{1, 1, 2, 3, 3,4,4,5}));
